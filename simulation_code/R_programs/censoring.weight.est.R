censoring.weight.est = function(Data,SurvTime,Status,covariateC){
  ...
  ###the following part is to compute K_i(t_j),i.e., survival probability
  ...
  Rc1 = as.matrix(ss1rs[n:1,]) #n*p matrix
  ...
  res = list(Kij=Kij, Omega=Omega, G=G, U=U)
  return(res)
}
