#' Create a score function for use in a pim.co.
#' 
...
#' 
#' This function is borrowed from R pcakge "pim" by Joris Meys et al.(2020) (https://cran.r-project.org/web/packages/pim/index.html)
