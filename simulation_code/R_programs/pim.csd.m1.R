...
pim.csd.m1 = function(formula, data, SurvTime, Status, covariateC = NULL, priority = 1:2, 
                      L = Inf, adjusted = c("unadjusted","IPCW"), start = NULL, 
  ...
  if(adjusted == "unadjusted" | link == "logit"){ 
    ...
    weight_res = ipcw.weight.m1(tdata,trt_con,censoring_weight,win_status,priority,determined_flag,L,n_ep)
