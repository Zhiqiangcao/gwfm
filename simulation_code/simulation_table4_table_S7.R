#This program can reproduce simulation results in Table 4 of main text and Web Table S7
...
for(case in case_set){
  ...
  res = round(resu,3)
  write.csv(res,paste0("table4_choice_",choice,"_case_",case,"_n_",n,".csv"))
  cat("case=",case,"\n")
}

##Note, if we modify the following line in ipcw.weight.m2.R
#double_weight[double_weight<0.01] = 0.01 
#to double_weight[double_weight<0.1] = 0.1 
#and keep all other code unchanged (including this program and all other auxiliary code) 
#then, we can reproduce simulation results in Web Table S7